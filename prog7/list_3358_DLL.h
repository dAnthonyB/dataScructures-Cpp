...
#ifndef LIST_3358_DLL_H
#define LIST_3358_DLL_H
...
class List_3358_DLL
{
   ...
   List_3358_DLL ( const List_3358_DLL & src );
   ...
   void showList() const;
   List_3358_DLL <ItemType>& operator = (const List_3358_DLL src );
   string toString();
   void emptyList();
   ...
   ********************************/
   template<class ItemType>
   List_3358_DLL<ItemType>::List_3358_DLL()
   {
      head = NULL;
      tail = NULL;
      cursor = NULL;
   ...
   template<class ItemType>
   List_3358_DLL<ItemType>::List_3358_DLL( const List_3358_DLL & src )
   {
      Node *temp;
   ...
   template<class ItemType>
   void List_3358_DLL<ItemType>::insert( const ItemType & item )
   {
      Node *newNode;
      newNode = new Node;
      newNode->value = item;
   ...
   template<class ItemType>
   void List_3358_DLL<ItemType>::remove()
   {
   ...
   template<class ItemType>
   void List_3358_DLL<ItemType>::reset()
   {
      cursor = head;
   }

   template<class ItemType>
   void List_3358_DLL<ItemType>::goToEnd()
   {
       cursor = tail;
   }

   template<class ItemType>
   bool List_3358_DLL<ItemType>::advance()
   {
   ...
   template<class ItemType>
   bool List_3358_DLL<ItemType>::isEmpty() const
   {
      return (head == NULL && tail == NULL);
   }

   template<class ItemType>
   bool List_3358_DLL<ItemType>::atEOL() const
   {
      return (cursor == NULL && tail != NULL);
   }

   template<class ItemType>
   bool List_3358_DLL<ItemType>::isFull() const
   {
      try
      {
         Node *temp = new Node;
   ...
   template<class ItemType>
   ItemType List_3358_DLL<ItemType>::getCurrent() const
   {
        return cursor->value;
   }

   template<class ItemType>
   void List_3358_DLL <ItemType>::showList(ofstream& outFile) const
   {
      Node* temp = head;
   ...
   template<class ItemType>
   void List_3358_DLL <ItemType>::showList() const
   {
      Node* temp = head;
      while(temp->next != NULL)
	  {
   ...
   template<class ItemType>
   List_3358_DLL <ItemType>& List_3358_DLL <ItemType>::operator = ( List_3358_DLL src){
       Node *temp = NULL;
    ...
    template<class ItemType>
    string List_3358_DLL<ItemType>::toString(){
        string retString = "";
        while(!atEOL()){
    ...
    template<class ItemType>
    void List_3358_DLL<ItemType>::emptyList(){
        reset();
        while(!isEmpty()){
            remove();
        }
